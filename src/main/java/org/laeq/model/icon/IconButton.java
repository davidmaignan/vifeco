...
public class IconButton extends Group implements IconDecorator {
    ...
    public IconButton(IconSquare iconSquare, int size) {
        ...
        category2.setColor(ColorDefinition.white);
        ...
        bgOff.setFill(Paint.valueOf(ColorDefinition.white));

        bgOn = generateRectangle();
        bgOn.setFill(Paint.valueOf(ColorDefinition.cyan));

        bgHover = generateRectangle();
        bgHover.setFill(Paint.valueOf(ColorDefinition.white));
